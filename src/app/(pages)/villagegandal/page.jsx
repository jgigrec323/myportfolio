...
function Villagegandal() {
  const infos = {
    ...
    year: "2023",
    mainImg: `${process.env.BASE_PATH}/images/villagegandal/1.png`,
    secondImg: `${process.env.BASE_PATH}/images/villagegandal/2.png`,
    firstText:
    ...
    imgs: [
      `${process.env.BASE_PATH}/images/villagegandal/3.png`,
      `${process.env.BASE_PATH}/images/villagegandal/4.png`,
    ],
  };
